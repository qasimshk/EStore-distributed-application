...
namespace estore.api.Persistance.Migrations
{
    ...
    [Migration("20240606140532_CreateDatabase")]
            ...
            modelBuilder.Entity("estore.api.Models.Aggregates.Customer.Customer", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("CustomerAddress", "estore.api.Models.Aggregates.Customer.Customer.CustomerAddress#Addresses", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("estore.api.Models.Aggregates.Employee.Employee", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("EmployeeAddress", "estore.api.Models.Aggregates.Employee.Employee.EmployeeAddress#Addresses", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("estore.api.Models.Aggregates.Orders.Order", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ShippingAddress", "estore.api.Models.Aggregates.Orders.Order.ShippingAddress#Addresses", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("estore.api.Models.Aggregates.Orders.Entities.OrderDetail", b =>
                {
                    ...
                    b.HasOne("estore.api.Models.Aggregates.Product", "Item")
                        .WithOne()
                        .HasForeignKey("estore.api.Models.Aggregates.Orders.Entities.OrderDetail", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
